...
#2. create the package folder with files in the getwd() directory
package.skeleton(list=c("anyIncomplete","filterTable","graphTable","checkDuplicates_vect","changeNames"),"tableSMY")
